      ...
      <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20 lg:py-24">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-12 xl:gap-16">
          <div className="min-w-0">
            ...
            <h1 className="mt-3 text-3xl font-bold leading-tight sm:text-4xl xl:text-5xl">
              {t("heroCta", locale)}
            </h1>
            ...
            <div className="mt-6 flex flex-wrap gap-x-4 gap-y-2 text-sm text-teal-100 lg:mt-8">
